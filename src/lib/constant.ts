...
export const DataWorkingExperience = [
    {
        label: 'PT Aksamedia',
        sub: 'Front End Developer | React, Typescript, CI/CD',
        rightContent: 'Sep 2022 - Dec 2023',
    },
    {
        label: 'Freelancing',
        sub: 'Front End Developer | SvelteKit, Typescript, Cloudflare Pages',
        rightContent: 'Jun 2022 - Jul 2022',
    },
    {
        label: 'PT Andromedia',
        sub: 'Fullstack Developer | Angular, PHP, Yii, PostgreSQL',
        rightContent: 'Feb 2022 - Jul 2022',
    },
    {
        label: 'Freelancing',
        sub: 'Front End Developer | Svelte, Typescript, Cloudflare Pages',
        rightContent: 'Jul 2021 - Aug 2021',
    },
]

export const DataProjects = [
    {
        imgAlt: 'Chitomask Project',
        imgSrc: '/images/chitomask.png',
        name: 'Chitomask',
        description:
    ...
    },
    {
        ...
        imgSrc: '/images/indonesia-after-covid.png',
        name: 'Indonesia After Covid',
        description:
    ...
    },
    {
        ...
        imgSrc: '/images/selfcommerce.png',
        name: 'Self Commerce App',
        description:
